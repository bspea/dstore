        ...
        <div class="row">
            <div class="col-md-2">
                <ul class="nav nav-pills nav-stacked left-side-nav-stacked">
                    ...
                    <c:if test="${loginUser.memberStatusNo eq 2}">
                    	<li role="presentation"><a href="oneOnOne.do?" onclick="window.open(this.href, '_blanck', 'width=380, height=500, left=100, toolbars=no, menubar=no'); return false">1:1 채팅문의</a></li>
                    </c:if>
                    
					<c:if test="${ loginUser.memberStatusNo eq 3}">
						<li role="presentation"><a href="goChatRoom.do" onclick="window.open(this.href, '_blanck', 'width=380, height=500, left=100, toolbars=no, menubar=no'); return false">1:1 채팅방 입장</a></li>
	                    <li role="presentation"><a href="csRepresentative.do">상담사 전용</a></li>
					</c:if>
	                    
	                    <script>
							$(function(){
								console.log("${loginUser.memberStatusNo}");
							});
	                    </script>
